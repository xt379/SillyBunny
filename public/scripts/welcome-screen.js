...
const WELCOME_BUNDLED_ASSISTANTS = Object.freeze([
    Object.freeze({
        ...
        title: 'Bunny Guide',
        body: 'Our bundled bunny assistant. It can explain what an LLM is, what providers and models mean, how Fairy differs from other similar platforms, and where presets, personas, and world info reside in the context of your RP or story.',
        credit: 'Created by purachina.',
        creator: 'purachina',
        creatorNotes: 'Automatically created bundled Bunny Guide character. Feel free to edit.',
        description: 'A calm built-in bunny assistant for explaining Fairy, model providers, presets, personas, and related basics in plain English.',
        ...
        questions: Object.freeze([
            ...
            'How is Fairy different from other chat platforms?',
        ]),
    ...
    return {
        ...
        optionalOfficial: [
            ...
            buildExtensionStarterPackItem({
                ...
                body: 'A popular CSS theme originally designed for a similar platform with a clean and modern design, adapted for use in Fairy.',
                icon: 'fa-moon',
        ...
        optionalUnofficial: [
            ...
            buildExtensionStarterPackItem({
                title: 'LALib',
                body: 'A library of STScript commands - a common dependency for many popular extensions.',
                icon: 'fa-toolbox',
...
globalThis.FairyShell = /** @type {any} */ (globalThis.FairyShell || {});
globalThis.FairyShell.highlightLaunchpadItem = highlightLaunchpadItem;
...
function openShellTab(route) {
    ...
    if (globalThis.FairyShell?.openTab) {
        globalThis.FairyShell.openTab(shellKey, tabId);
        return true;
    }
...
async function handleWelcomeAction(button, sendTextArea) {
    ...
    switch (action) {
        ...
        case 'open-characters-menu':
            globalThis.FairyShell?.openCharacters?.();
            break;
        case 'open-global-search':
            globalThis.FairyShell?.openGlobalSearch?.({ focusInput: true });
            break;
...
async function sendWelcomePanel(chats, expand = false) {
    try {
        ...
        window.FairyFrontendIcon?.apply?.();
        if (expand) {
